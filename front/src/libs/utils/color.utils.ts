// File: lakovna/front/src/libs/utils/color.utils.ts
// File: sendeliver/front/src/libs/utils/color.utils.ts
// Last change: Made truly universal by removing project-specific imports and types
