...
// Last change: Fixed type assertion for projectRoleColors object access.

import type { HslColor, ProjectOrgType, ThemeMode } from 'common/types/project.types';
import { PROJECT_COLOR_CONFIG } from 'common/configs/project-colors.config';
import { APP_CONFIG } from 'common/configs/app.config';

const STORAGE_KEYS = APP_CONFIG.technical.storageKeys;
...
export const getUserRoleColor = async (
  ...
  return PROJECT_COLOR_CONFIG.projectRoleColors[role as keyof typeof PROJECT_COLOR_CONFIG.projectRoleColors];
};
