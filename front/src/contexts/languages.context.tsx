...
// Last change: Fixed imports to use new common/configs and common/utils structure
...
} from 'common/utils/language-group.utils';

import {
  getLocalFlagUrl,
  getCdnFlagUrl,
  
} from 'common/utils/language-flag.utils';
...
export const LanguagesProvider: React.FC<LanguagesProviderProps> = ({ children, geoApi }) => {
  ...
  const availableLangs = useMemo(() => {
    if (!languageRestrictions) return undefined;
